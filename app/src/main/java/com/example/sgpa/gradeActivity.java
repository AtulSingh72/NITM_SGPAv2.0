...
public class gradeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(branch==11 || branch==22)            //First sem section A and Second sem section B
        {
        ...
        if(branch==12 || branch==21)            //Second sem section A and Second sem section B
        {
                                    ...
                                    button.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            button.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    marks[0] +=(6*thismarks[0]);
                                                    subject.setText("Software Engineering LAB");     //Algorithms lab
                                                    spinn.setAdapter(pr);
                                                    spinn.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                                        @Override
                                                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                                    ...
                                                    button.setOnClickListener(new View.OnClickListener() {
                                                        ...
                                                        public void onClick(View v) {
                                                            ...
                                                            button.setOnClickListener(new View.OnClickListener() {
                                                                ...
                                                                public void onClick(View v) {
                                                                    marks[0] +=(3*thismarks[0]);
                                                                    subject.setText("Machine Learning LAB");     //Peripherals and Accessories LAB
                                                                    spinn.setAdapter(pr);
                                                                    spinn.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                                                        @Override
                                                                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(gradeActivity.this, Main1Activity.class);
        startActivity(intent);
        finish();
    }
}
